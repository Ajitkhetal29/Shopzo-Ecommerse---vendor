...
const modules = [
  ...
  { name: "Inventory", value: "Stock levels", tone: "bg-cyan-500" },
    ...
    <main className="min-h-dvh bg-[#f5f7fb] text-slate-950 dark:bg-zinc-950 dark:text-white">
      ...
      <div className="grid min-h-dvh lg:grid-cols-[minmax(0,0.95fr)_minmax(520px,1.05fr)]">
        <section className="relative hidden overflow-hidden bg-slate-950 text-white lg:block">
          <div className="absolute inset-0 vendor-login-backdrop" aria-hidden />
          <div className="relative flex h-full min-h-[720px] flex-col justify-between px-10 py-8 xl:px-14">
            ...
            <div className="max-w-xl">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-300">Seller portal</p>
              <h1 className="mt-4 text-5xl font-semibold leading-[1.03] tracking-normal xl:text-6xl">
                Sell smarter from your vendor workspace.
              </h1>
              <p className="mt-5 max-w-lg text-base leading-7 text-slate-300">
                Manage products, stock levels, and inventory transfers — aligned with the Shopzo buyer experience.
              </p>
            ...
            <div className="grid grid-cols-3 gap-4 border-t border-white/10 pt-6">
              ...
              <Metric value="24/7" label="seller access" />
              <Metric value="Fast" label="fulfillment" />
            </div>
          </div>
        </section>
